...
{
    public static Pokemon MyGarchomp = new("Chompa", Garchomp, [0, 252, 0, 0, 0, 252 ], Nature.Adamant, 50, [Earthquake, StoneEdge, Dragonclaw, Swordsdance]);
    ...
    public static Pokemon MyZapdos = new("Zappy-Flappy", Zapdos, [0, 0, 0, 252, 0, 252], Nature.Timid, 50, [Thunderbolt, Roost]);
